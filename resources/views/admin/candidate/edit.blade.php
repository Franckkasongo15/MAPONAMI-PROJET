                                    ...
                                    <div class="row row-space">
                                        <div class="col-5">
                                            <div class="input-group">
                                                ...
                                                <input class="input--style-4" type="text" name="firstname" value="{{$candidate['firstname']}}">
                                        ...
                                        <div class="col-5">
                                            <div class="input-group">
                                                ...
                                                <input class="input--style-4" type="text" name="pseudo" value="{{$candidate['pseudo']}}" >
                                    ...
                                    <div class="row row-space">
                                        <div class="col">
                                            <div class="input-group">
                                                ...
                                                <input class="input--style-4" type="text" name="name" value="{{$candidate['name']}}" >
                                    ...
                                    <div class="row row-space">
                                        <div class="col-6">
                                            <div class="input-group">
                                                ...
                                                <input class="input--style-4" type="email" name="email" value="{{$candidate['email']}}" >
                                        ...
                                        <div class="col-6">
                                            <div class="input-group">
                                                ...
                                                <input class="input--style-4" type="text" name="phone" value="{{$candidate['phone']}}" >
                                    ...
                                    <div class="row row-space">
                                        <div class="col">
                                            <div class="input-group">
                                                ...
                                                <textarea class="input--style-4" name="motivation"> {{$candidate['name']}} </textarea>
                                    ...
                                    <div class="row row-space">
                                        <div class="col">
                                            <div class="input-group">
                                                ...
                                                <textarea class="input--style-4" name="slogan" > {{$candidate['slogan']}} </textarea>
                                    ...
                                    <div class="row row-space">
                                        <div class="col">
                                            <div class="input-group">
                                                ...
                                                <input class="input--style-4" type="number" name="vote_number" value="{{$candidate['vote_number']}}">
